<template>
  <div class="shop_container">
    <ul class="shop_list" v-if="shop.length > 0">
      <li class="shop_li border-1px" v-for="(item,index) in shop" :key="index" @click="$router.push('/shop')" >
        <a>
          <div class="shop_left">
          ...
          <div class="shop_right">
            <section class="shop_detail_header">
              ...
              <ul class="shop_detail_ul">
                <li class="supports" v-for="(support,index1) in item.supports" :key="index1">{{support.icon_name}}</li>
              </ul>
            </section>
